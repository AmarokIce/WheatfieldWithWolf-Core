...
public class NEIRecipeGrinder extends TemplateRecipeHandler {
  ...
  public String getGuiTexture() {
    return WWWMain.ID + ":textures/gui/nei/grinder.png";
  }
  ...
  public void loadUsageRecipes(ItemStack ingredient) {
    ...
    else if (Util.itemStackEquals(new ItemStack(W3Items.grinder_knife), ingredient)) findAllRecipe();
    else WWWApi.GRINDER_RECIPES.forEach(it -> {
  ...
  private final class RecipeGrinderCached extends CachedRecipe {
    ...
    public List<PositionedStack> getOtherStacks() {
      ArrayList<PositionedStack> stacks = Lists.newArrayList();
      stacks.add(new PositionedStack(new ItemStack(W3Items.grinder_knife), 42, 36));
      return stacks;
    }
  }
}
