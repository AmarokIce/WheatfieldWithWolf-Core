...
public class CuttingBoardRenderer extends TileEntitySpecialRenderer {
  public static final ResourceLocation texture = new ResourceLocation(WWWMain.ID, "model/textures/cut_board.png");
  public static final ResourceLocation objModelLocation = new ResourceLocation(WWWMain.ID, "model/cut_board.obj");
  IModelCustom model;
  ...
  public void renderTileEntityAt(TileEntity tileEntity, double posX, double posY, double posZ, float f) {
    ...
    if (tile.itemInv != null) {
      ...
      GL11.glPushMatrix();
      {
        ...
        if (item.getEntityItem().getItem() == W3Items.knife) {
