...
public class ItemList {
    ...
    public static final Item cut_potato = new FoodFactory("cut_potato", 1, 0.1F);
    public static final Item cut_tomato = new FoodFactory("cut_tomato", 1, 0.1F);
    public static final Item cut_onion = new FoodFactory("cut_onion", 1, 0.1F);
    public static final Item cut_eggplant = new FoodFactory("cut_eggplant", 1, 0.1F);
    ...
    public static final Item cooked_cut_eggplant = new FoodFactory("cooked_cut_eggplant", 4, 0.3F);
    public static final Item cooked_cut_onion = new FoodFactory("cooked_cut_onion", 1, 0.1F);
